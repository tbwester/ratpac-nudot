...
This script runs the two optical simulations (plate-to-PMT with 420nm light and source-to-plate with 128nm light). The outputs (final counts of hits on the PMT) are saved to gqe\_data.txt. The parameters for the simulation stages are set within the bash script, and can (and should) be modified.
